...
// Buscar ou pegar Cidades da API IBGE
...
// Carregando (change) através do "getCities" 
document
...
function handleSelecteditem(event) {
    ...
    // Se sim, pegar os itens slecionados
    const alreadySelected = selectedItems.findIndex( item => {
        // Verificação se é verdadeiro (true) ou falso (false)
